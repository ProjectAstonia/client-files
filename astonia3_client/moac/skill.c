...
// Description of skills. Displays as a tooltip in-game
char *skilldesc[] = {

	// Hitpoints
	"Hitpoints are reduced as thou combatest enemies and sustainest injury. If thy hitpoints drops to zero thou willt die!",
	// Endurance
